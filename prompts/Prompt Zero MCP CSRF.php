...
- Ensure all survived mutants are killed. If after analysis there are no test cases that can be eliminated, then report and rewrite 
  the final test cases permutation operator.
- Ensure that the test cases are as minimal as possible while still achieving a high mutant kill rate; adhere to this principle throughout test case design.
